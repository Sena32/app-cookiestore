    ...
    <li class="nav-item">
      ...
      <li class="nav-item down">
        ...
        <ul class="dropdown-menu">
            <li><a class="" href="{{ url('/clients') }}">Relatório</a></li>
            <li><a class="" href="{{ url('/clients/create') }}">Cadastrar</a></li>
        </ul>
      </li>
      ...
      <li class="nav-item down">
        <a class="nav-link" >
            <svg width="2em" height="2em" viewBox="0 0 16 16" class="bi bi-file-arrow-down" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        <ul class="dropdown-menu">
            <li><a class="" href="{{ url('/orders') }}">Relatório</a></li>
            <li><a class="" href="{{ url('/orders/create') }}">Cadastrar</a></li>
        </ul>
      </li>
